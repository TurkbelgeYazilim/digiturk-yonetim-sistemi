...
$apiEndpoints = [
    [
        'name' => 'Başvuru Formu',
        'method' => 'GET',
        'endpoint' => '/views/bayi/webservis/endpoints/basvuru-form.php',
    ...
    [
        ...
        'method' => 'GET',
        'endpoint' => '/views/bayi/webservis/endpoints/campaigns.php',
    ...
    [
        'name' => 'Paket Listesi',
        'method' => 'GET',
        'endpoint' => '/views/bayi/webservis/endpoints/packages.php',
    ...
    [
        'name' => 'Ödeme Tipleri',
        'method' => 'GET',
        'endpoint' => '/views/bayi/webservis/endpoints/payment-types.php',
    ...
    [
        ...
        'method' => 'GET',
        'endpoint' => '/views/bayi/webservis/endpoints/user-info.php',
...
?>
  ...
  src="<?php echo $baseUrl; ?>/views/bayi/webservis/endpoints/basvuru-form.php" 
  width="100%" 
  height="800px" 
  frameborder="0" 
  scrolling="yes"&gt;
&lt;/iframe&gt;</code></pre>
  ...
  src="<?php echo $baseUrl; ?>/views/bayi/webservis/endpoints/basvuru-form.php?kampanya=1&paket=5" 
  width="100%" 
  height="800px" 
  frameborder="0" 
  scrolling="yes"&gt;
